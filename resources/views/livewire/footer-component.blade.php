											...
											<ul>
                                                    @auth
                                                        @if(Auth::user()->utype==="ADM")
                                                            <li class="menu-item"><a href="{{ route('admin.dashboard')}}" class="link-term">My Account</a></li>
                                                        @else
										...
										<div class="wrap-vertical-nav">
											<ul>
												...
												<li class="menu-item"><a href="#" class="link-term">Specials</a></li>
												 @auth
                                                        @if(Auth::user()->utype==="ADM")
                                                            <li class="menu-item"><a href="{{ route('admin.orders')}}" class="link-term">Order History</a></li>
                                                        @else
                                                            <li class="menu-item"><a href="{{ route('user.orders')}}" class="link-term">Order History</a></li>
                                                        @endif
                                                    @else --}}
                                                <li class="menu-item"><a href="{{route('login')}}"  class="link-term">Order History</a></li>
                                                 @endif
											</ul>
										</div>
									</div>
			...
			<div class="coppy-right-box">
				<div class="container">
					<div class="coppy-right-item item-left">
						<p class="coppy-right-text">{{$setting->copyright}}</p>
					</div>
