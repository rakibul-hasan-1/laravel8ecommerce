                    ...
                    <div class="detail-info">
                        ...
                        <div class="quantity">
                            ...
                            <div class="quantity-input">
                                ...
                                <a class="btn btn-increase" href="#" wire:click.prevent="increseQuantity"></a>
                            </div>
                        </div>
                        <div class="wrap-butons">
                            @if ($product->sale_price>0 && $sale->status==1 && $sale->sale_date>Carbon\Carbon::now())
                                <a href="#" wire:click.prevent="store({{$product->id}},'{{$product->name}}','{{$product->sale_price}}')" class="btn add-to-cart">Add to Cart</a>
                            @else
                                                ...
                                                <div id="comment-20" class="comment_container">
                                                    ...
                                                    <div class="comment-text">
                                                        <div class="star-rating">
                                                            <span class="width-{{$orderItem->review->rating*20}}-percent">Rated <strong class="rating">1</strong> out of 5</span>
                                                        </div>
                                                        <p class="meta">
                                ...
                                <div class="product product-widget-style">
                                    <div class="thumbnnail">
                                        <a href="{{route('product.details',['slug'=>$p_products->slug])}}" title="{{$p_products->name}}">
                                            <figure><img src="{{ asset('assets/images/products')}}/{{$p_products->image}}" alt=""></figure>
                                        </a>
                                    </div>
                        ...
                        <div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"3"},"1200":{"items":"5"}}' >
                            ...
                            <div class="product product-style-2 equal-elem ">
                                <div class="product-thumnail">
                                    ...
                                    <div class="wrap-btn">
                                        <a href="{{route('product.details',['slug'=>$r_products->slug])}}" class="function-link">quick view</a>
                                    </div>
                                </div>
                                <div class="product-info">
                                    <a href="{{route('product.details',['slug'=>$r_products->slug])}}" class="product-name"><span>{{$r_products->name}}</span></a>
                                    <div class="wrap-price"><span class="product-price">${{$r_products->regular_price}}</span></div>
                                </div>
                            </div>
