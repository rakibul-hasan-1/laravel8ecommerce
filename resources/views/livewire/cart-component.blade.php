	<main id="main" class="main-site">
		...
		<div class="container">
			...
			<div class=" main-content-area">
				...
				<div class="summary">
					<div class="order-summary">
                        ...
                        @if(Session::has('coupon'))
                            ...
                            <p class="summary-info"><span class="title">Subtital with Discount</span><b class="index">${{number_format($subtotalAfterDiscount,2)}}</b></p>
                ...
                <div class="wrap-iten-in-cart">
                    <h3>{{Cart::instance('saveForLater')->count()}} item(s) Save For Later</h3>
                    @if(Cart::instance('saveForLater')->count()>0)
                        @if(Session::has('s_message'))
                        <div class="alert alert-success">
                            <strong>Success</strong>{{Session::get('s_message')}}
                        </div>
                        @endif
					<h3 class="box-title">Products Name</h3>
					<ul class="products-cart">
