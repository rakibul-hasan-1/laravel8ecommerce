            ...
            <div class="row">
                  ...
                  <div class="icon-stat">
                    <div class="row">
                      <div class="col-xs-8 text-left">
                        <span class="icon-stat-label">Total Spend</span>
                ...
                <div class="col-md-3 col-sm-6">
                  <div class="icon-stat">
                    <div class="row">
                      <div class="col-xs-8 text-left">
                        <span class="icon-stat-label">Total Delivered Order</span>
                ...
                <div class="col-md-3 col-sm-6">
                  <div class="icon-stat">
                    <div class="row">
                      <div class="col-xs-8 text-left">
                        <span class="icon-stat-label">Today Spend</span>
                        <span class="icon-stat-value">${{$todayTotalRevenue}}</span>
                      </div>
                      <div class="col-xs-4 text-center">
                        <i class="fa fa-dollar icon-stat-visual bg-primary"></i>
                      </div>
                  ...
                  <div class="icon-stat">
                    <div class="row">
                      <div class="col-xs-8 text-left">
                        ...
                        <span class="icon-stat-value">{{$todayTotalSales}}</span>
                      </div>
                      <div class="col-xs-4 text-center">
                        <i class="fa fa-gift icon-stat-visual bg-secondary"></i>
                      </div>
