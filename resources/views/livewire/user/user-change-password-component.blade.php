                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" wire:submit.prevent="changePassword">
                            <div class="form-group" >
                                ...
                                <div class="col-md-4">
                                    <input type="password" placeholder="Current Password" class="form-control input-md" wire:model="current_password">
                            ...
                            <div class="form-group" >
                                <label for="" class="col-md-4 control-label">Password Confirmation</label>
                                <div class="col-md-4">
                                    <input type="password" placeholder="Password Confirmation" class="form-control input-md" wire:model="password_confirmation">
