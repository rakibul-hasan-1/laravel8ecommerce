...
use App\Http\Livewire\AddHomesComponent;
...
use App\Http\Livewire\PrivacyAndPolicyComponent;
...
Route::get('/privacy-policy',PrivacyAndPolicyComponent::class)->name('privacy-policy');
Route::get('/return-policy',ReturnPolicyComponent::class)->name('return-policy');
Route::get('/terms-conditions',TermsAndConditionsComponent::class)->name('terms-conditions');
Route::get('/homes',AddHomesComponent::class)->name('homes');
